...
!function(i, h, m, e, d, k, f) {
    ...
    var b = i.$Jssor$ = new function() {
        ...
        function z(i, u, h, M, o) {
            i = i || {};
            h = x({}, h);
            var ab = h.$Elmt, p = {}, W = {}, w, y, r = h.je, P = h.Vb, F = k(Hb(h.$Easing)), V = k(h.Yc), X = k(h.$During), Z = k(h.$Round), Y = k(h.zd, E), G = S(u);
            i = k(i, f, d);
            u = k(u, f, d);
            var U = B()
              , K = o ? {
    ...
    var u = i.$JssorSlideshowFormations$ = new function() {
        ...
        i.$FormationSwirl = function(r) {
            var y = r.$Cols, z = r.$Rows, C = r.$Assembly, x = r.uc, B = [], A = [], v = 0, c = 0, i = 0, s = y - 1, t = z - 1, u, q, w = 0;
            switch (C) {
            case k:
                c = s;
                i = 0;
        ...
        i.$FormationZigZag = function(q) {
            var x = q.$Cols, y = q.$Rows, A = q.$Assembly, w = q.uc, u = [], v = 0, c = 0, d = 0, r = x - 1, s = y - 1, z, i, t = 0;
            switch (A) {
            case k:
                c = r;
                d = 0;
    ...
    i.$JssorSlideshowRunner$ = function(n, q, o, r, w, v) {
        ...
        function p(s, g, a, t, o, n) {
            var h, e, j = a.$ChessMode.$Column || 0, m = a.$ChessMode.$Row || 0, i = a.Uf(o, n), p = a.$Formation(a), r = a.$SlideOut;
            g = b.bb(g);
            b.N(g, 1);
            b.Bb(g, "hidden");
            b.db(g, "absolute");
